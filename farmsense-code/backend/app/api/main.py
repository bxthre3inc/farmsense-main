...
from app.api.routers import hardware, users, metrics, grants, analytics, compliance, trading, federated, auth, fields
...
app.include_router(fields.router, prefix="/api/v1/fields", tags=["Field Management & Boundaries"])
